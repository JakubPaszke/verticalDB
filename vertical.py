        ...
        if filename.endswith(".pdf"):
            with pdfplumber.open(os.path.join(directory_path, filename)) as pdf:
                ...
                for page in pdf.pages:
                    full_text += page.extract_text() or ''  # Append text of each page and handle None
...
def interactive_query_session():
    print("\n\nSession started. Type 'exit' to end the session.")
    while True:
        ...
        if question.lower() == 'exit':
            ...
            print("Thinking...")
            time.sleep(1)  # Simulates thinking delay
...
# Execute the interactive session
